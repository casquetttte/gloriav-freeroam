...
Settings.personalVehicle = {
	...
	vehicles = {
		['Free'] = {
			['bmx'] = { name = 'BMX', cash = 0 },
			['gauntlet2'] = { name = 'Bravado Gauntlet', cash = 0 },
		...
		['Motorcycles'] = {
			...
			['bf400'] = { name = 'BF 400', cash = 110, rank = 7 },
		...
		['Prestige'] = {
			...
			['kx450f'] = { name = 'Kawasaki KX450F', cash = 2657, prestige = 2, rank = 30 },
			['phantom2'] = { name = 'Phantom Wedge', cash = 2553, prestige = 2, rank = 40 },
			['f1'] = { name = 'Formula A', cash = 3957, prestige = 3, rank = 50 },
